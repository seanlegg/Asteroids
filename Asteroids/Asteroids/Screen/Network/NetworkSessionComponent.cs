    ...
    class NetworkSessionComponent : GameComponent
    {
                                          ...
                                          InviteAcceptedEventArgs e)
        {
            ...
            try
            {
                ...
                //LoadingScreen.Load(screenManager, false, null, new BackgroundScreen(), busyScreen);
                LoadingScreen.Load(screenManager, false, null, null, busyScreen);
            }
            catch (Exception exception)
            {
                NetworkErrorScreen errorScreen = new NetworkErrorScreen(exception);

                LoadingScreen.Load(screenManager, false, null, new TitleBackgroundScreen(), new MainMenuScreen(), errorScreen);
            }
        }
