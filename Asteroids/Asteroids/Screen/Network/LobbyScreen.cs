...
namespace Asteroids
{
    ...
    class LobbyScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            isReadyTexture    = content.Load<Texture2D>("sprite/network/chat_ready");
            hasVoiceTexture   = content.Load<Texture2D>("sprite/network/chat_able");
            isTalkingTexture  = content.Load<Texture2D>("sprite/network/chat_talking");
            voiceMutedTexture = content.Load<Texture2D>("sprite/network/chat_mute");
        }
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (!IsExiting)
            {
                if (networkSession.SessionState == NetworkSessionState.Playing)
                {
                    ...
                    LoadingScreen.Load(ScreenManager, false, PlayerIndex.One, new GameplayScreen(networkSession));
                }
